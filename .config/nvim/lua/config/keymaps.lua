...
-- Removed: Ctrl+Tab now used for buffer switching in telescope.lua
...
-- vim.keymap.set("t", "<C-i>", "<cmd>wincmd k<cr>", { desc = "Go to Upper Window" }) -- Disabled: conflicts with Tab in terminals (like lazygit)
...
-- Prevent c and d from writing to clipboard (use black hole register)
